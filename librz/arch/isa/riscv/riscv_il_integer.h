...
DEFINE_LIFTER(lui, DECODE_RD_IMM, SIGNED(analysis->bits, SHIFTL0(CAST(32, IL_FALSE, imm), UN(32, 12))))
...
DEFINE_LIFTER_WITH_EFFECT(sw, DECODE_RS_RS_IMM_MEM, STOREW(ADD(rs2, imm), CAST(32, IL_FALSE, rs1)))
